...
const Sell = (props) => {
  ...
  // Handle input changes with simple validation
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await addDoc(collection(fireStore, "products"), {
        ...
        userEmail: auth.user.email, // Add this for delete functionality
        ...
        >
          ...
          <div className="p-6 pl-8 pr-8 pb-8">
            ...
            <form onSubmit={handleSubmit}>
              <div>
                <Input setInput={handleTitleChange} placeholder="Title" />
                {errors.title && (
              ...
              <div>
                <Input setInput={handleCategoryChange} placeholder="Category" />
                {errors.category && (
                  <p className="text-red-500 text-sm -mt-2 mb-2">
                    {errors.category}
                  </p>
              ...
              <div>
                <Input setInput={handlePriceChange} placeholder="Price" />
                {errors.price && (
                  <p className="text-red-500 text-sm -mt-2 mb-2">
                    {errors.price}
                  </p>
