  ...
  return (
    <div>
      <nav className="fixed z-50 w-full overflow-auto p-2 pl-3 pr-3 shadow-md bg-slate-100 border-b-4 border-solid border-b-white">
        ...
        <Link to="/wishlist" className="relative mx-4 flex items-center">
          <img src={Favorite} alt="Wishlist" className="w-6 h-6" />
          {wishlist.length > 0 && (
        ...
        {!user ? (
          ...
          <div ref={userBtnRef}>
            ...
            >
              <p style={{ color: "#002f34" }} className="font-bold ml-3">
